...
plt.plot(dates_test, y_test, label="Actual Demand", marker='o')

plt.plot(dates_test, rf_pred, label="Random Forest Forecast")

plt.plot(dates_test, xgb_pred, label="XGBoost Forecast")

plt.plot(dates_test, arima_pred, label="ARIMA Forecast")
...
evaluate_model(y_test_ml, xgb_pred, "XGBoost")
...
plt.plot(xgb_pred[:len(y_test)], label="XGBoost")
...
rmse_scores = [rmse_arima, rmse_xgb]
